...
public class ReviewControllerTest {
	...
	public void shouldAddReviewInTheModel(){
		...
		verify(model).addAttribute("selectedReview", review);//behavior verification
	}
	...
	public void shouldReturnSingleReviewView(){
		...
		assertEquals("review-view", result);//string literals need to be in quotation marks (review-view)
	}
	@Test
